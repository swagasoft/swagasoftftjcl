...
@Component({
  selector: 'app-edit-expense-two',
  templateUrl: './edit-expense-two.component.html',
  styleUrls: ['./edit-expense-two.component.scss'],
})
export class EditExpenseTwoComponent implements OnInit {
  ...
  updateExpense(){
    this.loading = true;
    console.log(this.expenseModel);
    this.userService.updateExpenseTwo(this.expenseModel).subscribe(
      res => {
        this.loading = false;
